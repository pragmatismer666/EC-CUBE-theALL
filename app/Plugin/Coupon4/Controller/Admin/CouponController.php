...
class CouponController extends AbstractController
{
     ...
     *
     * @return array
     * @Route("/%eccube_admin_route%/coupon", name="plugin_coupon_list")
    ...
    public function index(Request $request)
    {
        ...
        if ($Member->getRole() === 'ROLE_SHOP_OWNER') {
            $searchParams['shop_id'] = $Member->getShop()->getId();
        }
     ...
     * @Route("/%eccube_admin_route%/coupon/new", name="plugin_coupon_new", requirements={"id" = "\d+"})
     * @Route("/%eccube_admin_route%/coupon/{id}/edit", name="plugin_coupon_edit", requirements={"id" = "\d+"})
     */
     ...
     * @Route("/%eccube_admin_route%/coupon/{id}/enable", name="plugin_coupon_enable", requirements={"id" = "\d+"}, methods={"put"})
     ...
     *
     * @return RedirectResponse
     * @Route("/%eccube_admin_route%/coupon/{id}/delete", name="plugin_coupon_delete", requirements={"id" = "\d+"}, methods={"delete"})
     * @ParamConverter("Coupon")
     */
